...
ShopLocationResponseModel _$ShopLocationResponseModelFromJson(
        Map<String, dynamic> json) =>
    ShopLocationResponseModel(
...
Map<String, dynamic> _$ShopLocationResponseModelToJson(
        ShopLocationResponseModel instance) =>
    <String, dynamic>{
